...
This repository contains samples to explains the databinding using [WizardControl](https://help.syncfusion.com/wpf/wizard-control/getting-started).

## Syncfuion controls

This project used the following Syncfusion control(s):
* [WizardControl](https://www.syncfusion.com/wpf-controls/wizard-control)
